...
run_list_path = run_directory + "/run_list"
...
print "cat " + run_directory + "README.txt >> " + output_directory + "/data.html"
print "echo \"</h3>\" >> " + output_directory + "/data.html"

## generate fitness graphs

print "# generate graphs"
fitness_template = "python \"" + scripts_directory + "\"/single_column_graph.py -l -m " + output_directory + "/fitness_$.png Fitness 4 \"x50 updates\" " + run_directory + "$_??????/data/average.dat.gz*"
tasks_template = "python \"" + scripts_directory + "\"/multi_column_graph.py " + output_directory + "/tasks_$.png Tasks \"x50 updates\" " + run_directory + "$_??????/data/tasks.dat.gz*"
coalescent_template = "python \"" + scripts_directory + "\"/single_column_graph.py -m " + output_directory + "/coalescentgenerations_$.png \"Coalescent Generations\" 10 \"x50 updates\" " + run_directory + "$_??????/data/stats.dat.gz*"
...
for data_dir in data_dirs:
    ...
    #print "echo \"<p>" + data_dir + "</p>\" >> " + output_directory + "/data.html"
