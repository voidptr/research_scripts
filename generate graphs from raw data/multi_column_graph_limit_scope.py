...
# Set up options
usage = """usage: %prog [options] outfile y-axis x-axis start_update stop_update tasks_filename1 [tasks_filename2 ...]
...
start_update = int(args[3])

stop_update = int(args[4])

print start_update, stop_update

## tasks filename
inputfilenames = args[5:]
